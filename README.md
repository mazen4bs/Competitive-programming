...
Output
If Vasya managed to say hello, print "YES", otherwise print "NO".<br>
...
Output
In the only line print "YES" (without the quotes), if number n is almost lucky. Otherwise, print "NO" (without the quotes).<br>
solution: https://github.com/mazen4bs/Competitive-programming/blob/main/lucky_division.cpp
